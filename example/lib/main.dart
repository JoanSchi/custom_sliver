import 'coffee_colors.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'examples/sliver_clipper.dart';
import 'examples/sliver_layer_outside.dart';
import 'examples/sliver_layer_builder.dart';
import 'examples/sliver_padding_constraints.dart';

enum Example { outside, builder, clip, contraints }
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme:
            coffeeColors, //ColorScheme.fromSeed(seedColor: const Color(0xFFDFA878)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Custom Slivers'),
    );
  }
}
    ...
    return ScrollConfiguration(
        ...
        child: Scaffold(
            ...
            body: switch (example) {
              ...
              Example.contraints => SliverPaddingConstraints(axis: axis),
            },
